...
async def require_role(required_role_codes: list[str]):
...
async def require_permission(required_permission_codes: list[str]):
...
expert_required = require_role(["admin", "expert"])
team_required = require_role(["admin", "team"])